...
public class TwoClassesClassifier {
	String fileModel = "models/2-classes.model";
	String fileWordlist = "models/2-classes.wordlist";
	...
	public TwoClassesClassifier() throws Exception {
		init();
		loadModel();
		loadWordlist();
	}

	public TwoClassesClassifier(String model, String wordlist) throws Exception {
