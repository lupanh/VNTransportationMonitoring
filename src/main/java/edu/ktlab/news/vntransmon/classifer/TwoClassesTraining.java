...
public class TwoClassesTraining {
	static String folderCorpus = "data/classifier/2-classes";
	static String fileTraining = "models/2-classes.training";
	...
	public static void main(String[] args) throws Exception {
		...
		// Cross-validation
		new Train().main(new String[] { "-v", "10", "-s", "0", "-c", "1", fileTraining, fileModel });
